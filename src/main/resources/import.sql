...
INSERT INTO user(id, name, password, role) VALUES(2, 'tor', '{bcrypt}$2a$04$5v02dQ.kxt7B5tJIA4gh3u/JFQlxmoCadSnk76PnvoN35Oz.ge3GK', 'USER');

--a user with password 'q'
INSERT INTO user(id, name, password, role) VALUES(3, 'bet', '{bcrypt}$2a$04$9rrSETFYL/gqiBxBCy3DMOIZ6qmLigzjqnOGbsNji/bt65q.YBfjK', 'USER');

--another user with password 'a'
INSERT INTO user(id, name, password, role) VALUES(4, 'sir', '{bcrypt}$2a$04$2ao4NQnJbq3Z6UeGGv24a.wRRX0FGq2l5gcy2Pjd/83ps7YaBXk9C', 'USER');

--another user with password 'p'
INSERT INTO user(id, name, password, role) VALUES(5, 'cat', '{bcrypt}$2a$04$5v02dQ.kxt7B5tJIA4gh3u/JFQlxmoCadSnk76PnvoN35Oz.ge3GK', 'USER');

--another user with password 'q'
INSERT INTO user(id, name, password, role) VALUES(6, 'scar', '{bcrypt}$2a$04$9rrSETFYL/gqiBxBCy3DMOIZ6qmLigzjqnOGbsNji/bt65q.YBfjK', 'USER');

--a last user with password 'a'
INSERT INTO user(id, name, password, role) VALUES(7, 'chiu', '{bcrypt}$2a$04$2ao4NQnJbq3Z6UeGGv24a.wRRX0FGq2l5gcy2Pjd/83ps7YaBXk9C', 'USER');
