...
public class Status {
    ...
    public Map<String, String> oldRols; //	Map de nombre de jugador con su rol anterior (no puede ser DEAD; para desvelar el rol cuando un jugador muere)
    ...
    public Map<String, Integer> played; // contiene todos los jugadores. Se mantiene a 0 (jugado). Se pone a 1 cuando se inicia un turn solo a los que pueden jugar.
